import styles from '../../../../../../styles/bar-za-naslovnu/predlog-za-obroke/rizotaijelasarizotom.module.scss';
...
export default function RizotaIJelaSAPirincem() {
    const filtriraniObroci = uopstenooObrocima.filter(PojedinacniObrok =>
      PojedinacniObrok.podkategorija.includes("3.5"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Rižota i jela sa pirinčem</p>
      </div>
