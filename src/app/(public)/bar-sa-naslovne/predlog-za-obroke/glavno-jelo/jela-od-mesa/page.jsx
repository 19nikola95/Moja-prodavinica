import styles from '../../../../../../styles/bar-za-naslovnu/predlog-za-obroke/jelaodmesa.module.scss';
...
export default function JelaOdMesa() {
  const filtriraniObroci = uopstenooObrocima.filter(PojedinacniObrok =>
    PojedinacniObrok.podkategorija.includes("3.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Jela od mesa</p>
      </div>
