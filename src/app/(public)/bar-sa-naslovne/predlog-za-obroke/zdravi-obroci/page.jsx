import styles from '../../../../../styles/bar-za-naslovnu/predlog-za-obroke/zdraviobroci.module.scss';
import { GlavniMeniPredlogZaObroke } from "@/components/PredlogZaObroke/GlavniMeni/GlavniMeniZaObroke";
import { obroci } from '@/mocks/predlog-za-obroke-zdravi-obroci';
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Zdravi obroci</p>
      </div>
