import styles from '../../../../../../styles/bar-za-naslovnu/predlog-za-obroke/toplapredjela.module.scss';
...
export default function ToplaPredjela() {
  const filtriraniObroci = uopstenooObrocima.filter(PojedinacniObrok =>
    PojedinacniObrok.podkategorija.includes("6.3"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Topla predjela</p>
      </div>
