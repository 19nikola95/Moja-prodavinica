import styles from '../../../../../styles/bar-za-naslovnu/predlog-za-obroke/laganiobrociisalate.module.scss';
import { GlavniMeniPredlogZaObroke } from "@/components/PredlogZaObroke/GlavniMeni/GlavniMeniZaObroke";
import { obroci } from '@/mocks/predlog-za-obroke-lagani-obroci-i-salate';
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Lagani obroci i salate</p>
      </div>
