import styles from '../../../../../../styles/bar-za-naslovnu/predlog-za-obroke/torte.module.scss';
import { GlavniMeniPredlogZaObroke } from "@/components/PredlogZaObroke/GlavniMeni/GlavniMeniZaObroke";
import { obroci } from '@/mocks/predlog-za-obrok-torte';
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Torte</p>
      </div>
