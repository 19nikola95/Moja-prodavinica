import styles from '../../../../../../styles/bar-za-naslovnu/predlog-za-obroke/mafini.module.scss';
...
export default function Mafini() {
   const filtriraniObroci = uopstenooObrocima.filter(PojedinacniObrok =>
      PojedinacniObrok.podkategorija.includes("1.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Mafini</p>
      </div>
