import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/sredstvazaodrzavanjedomacinstva.module.scss';
...
export default function SredstvaZaOdrzavanjeDomacinstva() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("8.5")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Sredstva za održavanje domaćinstva</p>
      </div>
