import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/ostalo.module.scss';
import { KontenjerSaProizvodom } from '@/components/SviProizvodi/KontenjerSaProizvodom';
import { proizvodi } from '@/mocks/svi-proizvodi-ostalo';
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Ostalo</p>
      </div>
