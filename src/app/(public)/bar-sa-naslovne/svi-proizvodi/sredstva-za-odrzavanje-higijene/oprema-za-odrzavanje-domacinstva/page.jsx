import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/opremazaodrzavanjedomacinstva.module.scss';
...
export default function OpremaZaOdrzavanjeDomacinstva() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
      PojedinacniProizvod.podkategorija.includes("8.1")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Oprema za održavanje domaćinstva</p>
      </div>
