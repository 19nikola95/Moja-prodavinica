import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/sredstvazapranjesudova.module.scss';
...
export default function SredstvaZaPranjeSudova() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("8.6")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Sredstva pranje sudova</p>
      </div>
