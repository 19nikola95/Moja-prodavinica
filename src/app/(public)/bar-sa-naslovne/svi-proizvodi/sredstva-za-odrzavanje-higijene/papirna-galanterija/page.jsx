import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/papirnagalanterija.module.scss';
...
export default function PapirnaGalanterija() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("8.4")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Papirna galanterija</p>
      </div>
