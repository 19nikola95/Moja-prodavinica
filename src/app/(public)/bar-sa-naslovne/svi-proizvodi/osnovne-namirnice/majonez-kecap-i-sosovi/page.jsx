import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/majonezkecapisosovi.module.scss';
...
export default function MajonezKecapISosovi() {
    const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
        PojedinacniProizvod.podkategorija.includes("6.4"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Majonez kečap i sosovi</p>
      </div>
