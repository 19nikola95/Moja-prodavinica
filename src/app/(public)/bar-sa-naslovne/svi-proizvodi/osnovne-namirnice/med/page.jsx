import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/med.module.scss';
...
export default function Med() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.5"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Med</p>
      </div>
