import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/secer.module.scss';
...
export default function Secer() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.8"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Šećer</p>
      </div>
