import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/uljeisirce.module.scss';
...
export default function UljeISirce() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.11"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Ulja i sirće</p>
      </div>
