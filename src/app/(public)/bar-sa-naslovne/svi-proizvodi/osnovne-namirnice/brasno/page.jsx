import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/brasno.module.scss';
...
export default function Brasno() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Brašno</p>
      </div>
