import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/zimniceikonzerviranopovrce.module.scss';
...
export default function ZimniceIKonzerviranoVoceIPovrce() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.12"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Zimnice i konzervirano voće i povrće</p>
      </div>
