import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/pirinac.module.scss';
...
export default function Pirinac() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.6"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pirinač</p>
      </div>
