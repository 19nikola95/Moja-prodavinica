import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/soizacini.module.scss';
...
export default function SoIZacini() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.9"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>So i začini</p>
      </div>
