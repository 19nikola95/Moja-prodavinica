import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/testenine.module.scss';
...
export default function Testenine() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("6.10"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Testenine</p>
      </div>
