import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/instatsupeipirei.module.scss';
...
export default function InstantSupeIPirei() {
    const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
      PojedinacniProizvod.podkategorija.includes("6.3"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Instant supe i pirei</p>
      </div>
