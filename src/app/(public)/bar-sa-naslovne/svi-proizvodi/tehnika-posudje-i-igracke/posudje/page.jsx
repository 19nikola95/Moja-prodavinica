import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/posudje.module.scss';
...
export default function Posudje() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("10.3")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Posuđe</p>
      </div>
