import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/igracke.module.scss';
...
export default function Igracke() {
    const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
        PojedinacniProizvod.podkategorija.includes("10.2")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Igračke</p>
      </div>
