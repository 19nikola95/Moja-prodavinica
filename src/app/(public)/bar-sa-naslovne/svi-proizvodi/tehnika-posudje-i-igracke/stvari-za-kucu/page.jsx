import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/stvarizakucu.module.scss';
...
export default function StvariZaKucu() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("10.4")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Stvari za kuću</p>
      </div>
