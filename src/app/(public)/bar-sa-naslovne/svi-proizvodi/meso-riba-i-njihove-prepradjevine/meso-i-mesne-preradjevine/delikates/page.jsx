import styles from '../../../../../../../styles/bar-za-naslovnu/svi-proizvodi/delikates.module.scss';
...
export default function Delikates() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.ispodpodkategorije.includes("3.21"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Delikates</p>
      </div>
