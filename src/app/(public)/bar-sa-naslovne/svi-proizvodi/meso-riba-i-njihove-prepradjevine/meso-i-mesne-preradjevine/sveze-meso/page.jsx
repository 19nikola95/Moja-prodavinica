import styles from '../../../../../../../styles/bar-za-naslovnu/svi-proizvodi/svezemeso.module.scss';
...
export default function SvezeMeso() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.ispodpodkategorije.includes("3.25"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Sveže meso</p>
      </div>
