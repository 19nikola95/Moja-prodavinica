import styles from '../../../../../../../styles/bar-za-naslovnu/svi-proizvodi/pasteteimesnekonzerve.module.scss';
...
export default function PasteIMesneKonzerve() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.ispodpodkategorije.includes("3.24"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Paštete i mesne konzerve</p>
      </div>
