import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/gotovajela.module.scss';
...
export default function GotovaJela() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("3.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
   ...
   {ReklamneSlike.map((ReklamneSlika) => <FunkcijaReklama slika={ReklamneSlika.SLIKA} link={ReklamneSlika.LINK} />)}
      ...
      <p className={styles.IzgledSlovaNaslova}>Gotova jela</p>
      </div>
