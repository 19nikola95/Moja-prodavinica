...
import '../../../../../../../styles/bar-za-naslovnu/svi-proizvodi/_ribaglavnimeni.scss';
export default function pocetna() {
  return (
  <div>
  <div class="GlavniKontenjerZaSadrzaj">
      <div class="VideoReklame"></div>
      <p class="IzgledSlovaNaslova">Riba</p>
      ...
      <Link href="/bar-sa-naslovne/svi-proizvodi/meso-riba-i-njihove-prepradjevine/riba/sveza-riba">
        <button class="IzgledDugmetaZaObroke">Sveža riba</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/meso-riba-i-njihove-prepradjevine/riba/riblja-pasteta-i-riblje-konzerve">
        <button class="IzgledDugmetaZaObroke">Riblje paštet i riblje konzerve</button>
        </Link>
         </div>
