import '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/_voceipovrceglavnimeni.scss';
...
<div class="GlavniKontenjerZaSadrzaj">
      ...
      <p class="IzgledSlovaNaslova">Voće i povrće</p>
      ...
      <Link href="/bar-sa-naslovne/svi-proizvodi/voce-i-povrce/sveze-voce">
        <button class="IzgledDugmetaZaObroke">Sveže voće</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/voce-i-povrce/sveze-povrce">
        <button class="IzgledDugmetaZaObroke">Sveže povrće</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/voce-i-povrce/pakovane-salate">
        <button class="IzgledDugmetaZaObroke">Pakovane salate</button>
        </Link>
      </div>
