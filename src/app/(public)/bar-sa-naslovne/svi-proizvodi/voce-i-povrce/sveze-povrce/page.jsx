import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/svezepovrce.module.scss';
...
export default function SvezePovrce() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("11.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Sveže povrće</p>
      </div>
