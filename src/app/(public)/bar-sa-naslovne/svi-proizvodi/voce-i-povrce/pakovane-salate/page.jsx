import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/pakovanesalate.module.scss';
...
export default function PakovaneSalate() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("11.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pakovane salate</p>
      </div>
