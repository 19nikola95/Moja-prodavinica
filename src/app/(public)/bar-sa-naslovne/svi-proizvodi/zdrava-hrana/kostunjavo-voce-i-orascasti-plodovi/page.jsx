import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/kostunjavovoceiorascastiplodovi.module.scss';
...
export default function KostunjavoVoceIOrascastiPlodovi() {
   const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
      PojedinacniProizvod.podkategorija.includes("12.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Koštunjavo voće i orašasti plodovi</p>
      </div>
