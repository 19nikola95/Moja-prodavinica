import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/zdravahrana.module.scss';
...
export default function ZdravaHrana() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("12.4"));
  return (
  <div>
