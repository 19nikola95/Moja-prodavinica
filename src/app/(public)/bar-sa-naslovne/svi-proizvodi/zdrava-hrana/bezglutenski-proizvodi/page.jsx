import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/bezglutenskiproizvodi.module.scss';
...
export default function BezglutenskiProizvodi() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("12.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Bezglutenski proizvodi</p>
      </div>
