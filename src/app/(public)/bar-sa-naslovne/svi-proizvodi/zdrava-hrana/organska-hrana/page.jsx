import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/organskahrana.module.scss';
...
export default function OrgansaHrana() {
   const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
        PojedinacniProizvod.podkategorija.includes("12.3"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Organska hrana</p>
      </div>
