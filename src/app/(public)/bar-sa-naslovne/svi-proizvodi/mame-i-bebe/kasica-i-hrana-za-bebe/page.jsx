import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/kasicaihranazabebe.module.scss';
...
export default function KasicaIHranaZaBebe() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
      PojedinacniProizvod.podkategorija.includes("2.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Kašica i hrana za bebe</p>
      </div>
