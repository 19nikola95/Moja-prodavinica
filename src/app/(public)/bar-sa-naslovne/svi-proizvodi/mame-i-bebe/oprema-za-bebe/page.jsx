import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/opremazabebe.module.scss';
...
export default function OpremaZaBebe() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("2.3"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Oprema za bebe</p>
      </div>
