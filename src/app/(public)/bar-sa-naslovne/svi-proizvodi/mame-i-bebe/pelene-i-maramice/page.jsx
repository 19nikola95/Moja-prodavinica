import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/peleneimaramice.module.scss';
...
export default function PeleneIMaramice() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("2.4"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pelene i maramice</p>
      </div>
