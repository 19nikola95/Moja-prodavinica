import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/kozmetika.module.scss';
import { KontenjerSaProizvodom } from '@/components/SviProizvodi/KontenjerSaProizvodom';
import { proizvodi } from '@/mocks/svi-proizvodi-kozmetika';
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Kozmetika</p>
      </div>
