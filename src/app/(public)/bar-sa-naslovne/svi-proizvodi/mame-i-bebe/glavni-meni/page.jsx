...
import '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/_glavnimenimameibebe.scss'
export default function pocetna() {
  return (
  <div>
   <div class="GlavniKontenjerZaSadrzaj">
      <div class="VideoReklame"></div>
      <p class="IzgledSlovaNaslova">Mame i bebe</p>
      ...
      <Link href="/bar-sa-naslovne/svi-proizvodi/mame-i-bebe/pelene-i-maramice">
        <button class="IzgledDugmetaZaObroke">Pelene i maramice</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/mame-i-bebe/kasica-i-hrana-za-bebe">
        <button class="IzgledDugmetaZaObroke">Kašice i hrana za bebe</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/mame-i-bebe/oprema-za-bebe">
        <button class="IzgledDugmetaZaObroke">Oprema za bebe</button>
        </Link>
        <Link href="/bar-sa-naslovne/svi-proizvodi/mame-i-bebe/kozmetika">
        <button class="IzgledDugmetaZaObroke">Kozmetika</button>
        </Link>
       </div>
