import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/pudinziislatkisiucasicama.module.scss';
...
export default function PudinziIslatkisiucasicama() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.6"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pudinzi i slatkiši u čašicama</p>
      </div>
