import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/sirinamaziodsira.module.scss';
...
export default function SiriNamaziOdSira() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.7"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Sir i namazi od sira</p>
      </div>
