import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/jaja.module.scss';
...
export default function Jaja() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Jaja</p>
      </div>
