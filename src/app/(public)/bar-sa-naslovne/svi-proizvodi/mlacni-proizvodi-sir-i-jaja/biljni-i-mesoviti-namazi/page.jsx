import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/biljniimesovitinamazi.module.scss';
...
export default function BiljniIPesovitiNamazi() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Biljni i mešoviti namazi</p>
      </div>
