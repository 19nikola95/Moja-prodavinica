import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/jogurtikiselomlecniproizvodi.module.scss';
...
export default function JogurtIKiseloMlecniProizvodi() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.3"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Jogurt i kiselo mlečni proizvodi</p>
      </div>
