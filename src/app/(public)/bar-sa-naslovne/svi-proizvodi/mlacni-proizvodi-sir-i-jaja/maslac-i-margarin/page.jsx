import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/maslaciimargarin.module.scss';
...
export default function MaslacImargarin() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.4"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Maslac i margarin</p>
      </div>
