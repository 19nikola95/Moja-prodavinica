import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/slatkaineutralnapavlaka.module.scss';
...
export default function SlatkaINeutralnaPavlaka() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("4.8"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Slatka i neutralna pavlaka</p>
      </div>
