import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/sokovi.module.scss';
...
export default function Sokovi() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("5.7"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
    ...
    {ReklamneSlike.map((ReklamneSlika) => <FunkcijaReklama slika={ReklamneSlika.SLIKA} link={ReklamneSlika.LINK} />)}
      ...
      <p className={styles.IzgledSlovaNaslova}>Sokovi</p>
      </div>
