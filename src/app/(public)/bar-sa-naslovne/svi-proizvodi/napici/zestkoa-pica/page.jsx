import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/zestokapica.module.scss';
...
export default function ZestokaPica() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("5.9"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Žestoka pića</p>
      </div>
