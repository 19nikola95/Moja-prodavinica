import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/caj.module.scss';
...
export default function Caj() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("5.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Čaj</p>
      </div>
