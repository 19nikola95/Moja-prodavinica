import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/mineralnavoda.module.scss';
...
export default function MineralnaVoda() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("5.5"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Mineralna voda</p>
      </div>
