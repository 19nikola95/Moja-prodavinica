import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/energetskinapitci.module.scss';
...
export default function EnergetskiNapici() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("5.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Energetski napici</p>
      </div>
