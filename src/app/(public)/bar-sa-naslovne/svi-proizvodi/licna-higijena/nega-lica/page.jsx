import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/negalica.module.scss';
...
export default function NegaLica() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("1.5"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Nega lica</p>
      </div>
