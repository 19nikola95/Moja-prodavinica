import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/priborzanegurikiilicia.module.scss';
...
export default function PriborZaNeguRukuLicaTela() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("1.10"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pribor za negu ruku, lica i tela</p>
      </div>
