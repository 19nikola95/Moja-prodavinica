import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/negazamuskarce.module.scss';
...
export default function NegaZaMuskarce() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("1.8"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Nega za muškarce</p>
      </div>
