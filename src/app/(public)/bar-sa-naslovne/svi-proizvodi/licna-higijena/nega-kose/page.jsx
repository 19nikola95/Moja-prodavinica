import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/negakose.module.scss';
...
export default function NegaKose() {
    const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
        PojedinacniProizvod.podkategorija.includes("1.4"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Nega kose</p>
      </div>
