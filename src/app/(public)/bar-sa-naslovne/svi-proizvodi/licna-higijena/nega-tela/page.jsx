import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/negatela.module.scss';
...
export default function NegaTela() {
...
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Nega tela</p>
      </div>
