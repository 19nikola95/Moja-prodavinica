import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/negarukuistopala.module.scss';
...
export default function NegaRukuIStopala() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("1.6"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Nega ruku i stopala</p>
      </div>
