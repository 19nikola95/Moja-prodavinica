import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/dezadoransiitotalnevode.module.scss';
...
export default function DezadoransiiTolatneVode() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("1.7"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Dezadoransi i toaletne vode</p>
      </div>
