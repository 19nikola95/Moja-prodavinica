import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/hranazapse.module.scss';
...
export default function HranaZaPse() {
    const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
      PojedinacniProizvod.podkategorija.includes("9.3")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Hrana za pse</p>
      </div>
