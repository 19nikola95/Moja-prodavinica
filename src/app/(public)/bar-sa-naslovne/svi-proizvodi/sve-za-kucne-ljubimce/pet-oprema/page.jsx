import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/petoprema.module.scss';
...
export default function PetOprema() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("9.4")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Pet oprema</p>
      </div>
