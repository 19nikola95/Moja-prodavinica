import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/hranazamacke.module.scss';
...
export default function HranaZaMacke() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("9.1")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Hrana za mačke</p>
      </div>
