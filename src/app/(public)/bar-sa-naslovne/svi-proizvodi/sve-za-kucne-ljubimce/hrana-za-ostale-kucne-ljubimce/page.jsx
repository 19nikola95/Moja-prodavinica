import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/hranazaostalekucneljubimce.module.scss';
...
export default function HranaZaOstaleKucneLjubimce() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("9.2")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Hrana za ostale kućne ljubimce</p>
      </div>
