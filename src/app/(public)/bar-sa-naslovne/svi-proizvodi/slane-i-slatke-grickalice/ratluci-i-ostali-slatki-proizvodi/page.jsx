import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/ratluciiostaliproizvodi.module.scss';
...
export default function RatluciIOstaliSlatkiProizvodi() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("7.4"));   
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Ratluci i ostali slatki proizvodi</p>
      </div>
