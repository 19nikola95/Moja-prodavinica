import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/zvakeibombone.module.scss';
...
export default function ZvakeIbimbone() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("7.6")); 
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Žvake i bombone</p>
      </div>
