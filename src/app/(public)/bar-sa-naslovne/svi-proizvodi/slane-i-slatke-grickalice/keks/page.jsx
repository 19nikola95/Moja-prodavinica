import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/keks.module.scss';
...
export default function Keks() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("7.2"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Keks</p>
      </div>
