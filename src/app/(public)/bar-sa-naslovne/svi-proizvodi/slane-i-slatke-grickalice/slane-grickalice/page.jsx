import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/slanegrickalice.module.scss';
...
export default function SlaneGrickalice() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("7.5"));   
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Slane grickalice</p>
      </div>
