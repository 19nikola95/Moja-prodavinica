import styles from '../../../../../../styles/bar-za-naslovnu/svi-proizvodi/cokoleicokoladice.module.scss';
...
export default function CokoladeICokloadice() {
  const filtriraniProizvodi = opisproizvoda.filter(PojedinacniProizvod =>
    PojedinacniProizvod.podkategorija.includes("7.1"));
  return (
  <div>
<div className={styles.GlavniKontenjerZaSadrzaj}>
      ...
      <p className={styles.IzgledSlovaNaslova}>Čokolada i čokoladice</p>
      </div>
